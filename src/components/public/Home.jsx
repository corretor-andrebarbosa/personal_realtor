...
const PublicHome = () => {
    ...
    return (
        <div className="font-[Manrope] min-h-screen bg-slate-50 flex flex-col scroll-smooth">
            ...
            <section id="vender" className="py-20 px-6 bg-slate-900 relative overflow-hidden">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
                        ...
                        <div>
                            ...
                            <a
                                ...
                                target="_blank"
                                rel="noreferrer"
                                className="inline-flex items-center gap-3 bg-[#25D366] text-white px-8 py-4 rounded-full font-bold text-base hover:bg-[#1da851] transition-all shadow-lg hover:shadow-green-500/25 hover:-translate-y-0.5"
                            >
                        ...
                        <div className="bg-white/5 backdrop-blur-sm border border-white/10 rounded-2xl p-8 flex flex-col gap-4">
                            ...
                            <div className="mt-2 flex flex-col gap-2 text-xs text-slate-500">
                                ...
                                <span className="flex items-center gap-2"><span className="w-1.5 h-1.5 rounded-full bg-amber-500/50 shrink-0"></span>Upload de fotos e vídeos via link</span>
                            </div>
                        </div>
                    </div>
                </div>
